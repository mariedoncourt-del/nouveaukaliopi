...
<a class="btn btn-primary" href="<?php echo base_url().'admin/scenario_pedagogique' ?>">Scénario pédagogique</a> 

<a class="btn btn-primary" href="<?php echo base_url().'admin/gestion_scenario_pedagogique' ?>">Gestion des scénarios</a>
	<br>
</div>
