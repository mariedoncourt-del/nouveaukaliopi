<h1 class="h3 mb-2 text-gray-800">Indicateurs de Résultats</h1>
...
<div class="card shadow mb-4">
	...
	<div class="card-body">
        ...
        <form method="post" action="<?php echo site_url('admin/fichierexcelsatisfaction'); ?> ">
                <div class="form-group row">
                <div class="col-lg-3">
                      <div class="input-group">
                         <!-- <input type="submit"  class="form-control btn btn-success" value="Exporter vers excel"> -->
                     </div>
                  </div>
...
$(document).ready(function(){
 ...
 function load_data_recherche($nom)
	...
	//	load_data();
       ...
       url : "https://maf-formation.org/kaliopi/admin/evaluation_formation_statistique",
        type: 'POST',
        success: function(data) {
           $('#resultat').html(data);
...
$('#modifier').click(function(){
    ...
    $.ajax({
        url: "<?php echo site_url('admin/modifier_admin'); ?>",
        type: 'POST',
        data: form_data,
        success: function(data) {
