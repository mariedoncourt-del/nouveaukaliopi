		...
		<?php foreach($question as $row){
			...
			<div class="form-group row">
                            ...
                            <div class="col-md-12">
									...
									<?php
										foreach($this->FormationModel->recherche_reponses_depart($row->id_questionnaire, 1) as $row1)
										{
											?>
									<div class="list-group-item radio form-control">
										...
										<?php
													...
													if($this->FormationModel->recherche_resultat_question_depart_1($id_formation,'Question 1')!=0)
													{
...
<?php
										foreach($this->FormationModel->recherche_reponses_depart($row->id_questionnaire, 2) as $row1)
										{
											?>
									<div class="list-group-item radio form-control">
											<label>
										<?php
											...
											if($this->FormationModel->recherche_resultat_question_depart_2($id_formation,'Question 1')!=0)
											{
...
<?php
										foreach($this->FormationModel->recherche_reponses_depart($row->id_questionnaire, 3) as $row1)
										{
											?>
									<div class="list-group-item radio form-control">
											<label>
										<?php
											...
											if($this->FormationModel->recherche_resultat_question_depart_3($id_formation,'Question 1')!=0)
											{
...
<?php
										foreach($this->FormationModel->recherche_reponses_depart($row->id_questionnaire, 4) as $row1)
										{
											?>
									<div class="list-group-item radio form-control">
											<label>
										<?php
											...
											if($this->FormationModel->recherche_resultat_question_depart_4($id_formation,'Question 1')!=0)
											{
							...
							<?php
									...
									<div class="list-group-item radio form-control">
										...
										<?php
													...
													if($this->FormationModel->recherche_resultat_question_depart_1($id_formation,'Question 2')!=0)
													{
							...
							<?php
									...
									<div class="list-group-item radio form-control">
										...
										<?php
													...
													if($this->FormationModel->recherche_resultat_question_depart_2($id_formation,'Question 2')!=0)
													{
								...
								<?php
									...
									<div class="list-group-item radio form-control">
										...
										<?php
													...
													if($this->FormationModel->recherche_resultat_question_depart_3($id_formation,'Question 2')!=0)
													{
...
<?php
									...
									<div class="list-group-item radio form-control">
										...
										<?php
													...
													if($this->FormationModel->recherche_resultat_question_depart_4($id_formation,'Question 2')!=0)
													{
							...
							<?php
									...
									<div class="list-group-item radio form-control">
										...
										<?php
													...
													if($this->FormationModel->recherche_resultat_question_depart_1($id_formation,'Question 3')==1)
													{
...
<?php
									...
									<div class="list-group-item radio form-control">
										...
										<?php
													...
													if($this->FormationModel->recherche_resultat_question_depart_2($id_formation,'Question 3')==1)
													{
							...
							<?php
									...
									<div class="list-group-item radio form-control">
										...
										<?php
													...
													if($this->FormationModel->recherche_resultat_question_depart_3($id_formation,'Question 3')==1)
													{
...
<?php
									...
									<div class="list-group-item radio form-control">
										...
										<?php
													...
													if($this->FormationModel->recherche_resultat_question_depart_4($id_formation,'Question 4')==1)
													{
							...
							<?php
									...
									<div class="list-group-item radio form-control">
										...
										<?php
													...
													if($this->FormationModel->recherche_resultat_question_depart_1($id_formation,'Question 4')==1)
													{
								...
								<?php
									...
									<div class="list-group-item radio form-control">
										...
										<?php
													...
													if($this->FormationModel->recherche_resultat_question_depart_2($id_formation,'Question 4')==1)
													{
...
<?php
									...
									<div class="list-group-item radio form-control">
										...
										<?php
													...
													if($this->FormationModel->recherche_resultat_question_depart_3($id_formation,'Question 4')==1)
													{
							...
							<?php
									...
									<div class="list-group-item radio form-control">
										...
										<?php
													...
													if($this->FormationModel->recherche_resultat_question_depart_1($id_formation,'Question 5')==1)
													{
...
<?php
									...
									<div class="list-group-item radio form-control">
										...
										<?php
													...
													if($this->FormationModel->recherche_resultat_question_depart_2($id_formation,'Question 5')==1)
													{
								...
								<?php
									...
									<div class="list-group-item radio form-control">
										...
										<?php
													...
													if($this->FormationModel->recherche_resultat_question_depart_3($id_formation,'Question 5')==1)
													{
								...
								<?php
									...
									<div class="list-group-item radio form-control">
										...
										<?php
													...
													if($this->FormationModel->recherche_resultat_question_depart_4($id_formation,'Question 5')==1)
													{
							...
							<?php
									...
									<div class="list-group-item radio form-control">
										...
										<?php
													...
													if($this->FormationModel->recherche_resultat_question_depart_1($id_formation,'Question 6')==1)
													{
								...
								<?php
									...
									<div class="list-group-item radio form-control">
										...
										<?php
													...
													if($this->FormationModel->recherche_resultat_question_depart_2($id_formation,'Question 6')==1)
													{
...
<?php
									...
									<div class="list-group-item radio form-control">
										...
										<?php
													...
													if($this->FormationModel->recherche_resultat_question_depart_3($id_formation,'Question 6')==1)
													{
								...
								<?php
									...
									<div class="list-group-item radio form-control">
										...
										<?php
													...
													if($this->FormationModel->recherche_resultat_question_depart_4($id_formation,'Question 6')==1)
													{
							...
							<?php
									...
									<div class="list-group-item radio form-control">
										...
										<?php
													...
													if($this->FormationModel->recherche_resultat_question_depart_1($id_formation,'Question 7')==1)
													{
...
<?php
									...
									<div class="list-group-item radio form-control">
										...
										<?php
													...
													if($this->FormationModel->recherche_resultat_question_depart_2($id_formation,'Question 7')==1)
													{
								...
								<?php
									...
									<div class="list-group-item radio form-control">
										...
										<?php
													...
													if($this->FormationModel->recherche_resultat_question_depart_3($id_formation,'Question 7')==1)
													{
								...
								<?php
									...
									<div class="list-group-item radio form-control">
										...
										<?php
													...
													if($this->FormationModel->recherche_resultat_question_depart_4($id_formation,'Question 7')==1)
													{
							...
							<?php
									...
									<div class="list-group-item radio form-control">
										...
										<?php
													...
													if($this->FormationModel->recherche_resultat_question_depart_1($id_formation,'Question 8')==1)
													{
							...
							<?php
									...
									<div class="list-group-item radio form-control">
										...
										<?php
													...
													if($this->FormationModel->recherche_resultat_question_depart_2($id_formation,'Question 8')==1)
													{
...
<?php
									...
									<div class="list-group-item radio form-control">
										...
										<?php
													...
													if($this->FormationModel->recherche_resultat_question_depart_3($id_formation,'Question 8')==1)
													{
								...
								<?php
									...
									<div class="list-group-item radio form-control">
										...
										<?php
													...
													if($this->FormationModel->recherche_resultat_question_depart_4($id_formation,'Question 8')==1)
													{
							...
							<?php
									...
									<div class="list-group-item radio form-control">
										...
										<?php
													...
													if($this->FormationModel->recherche_resultat_question_depart_1($id_formation,'Question 9')==1)
													{
...
<?php
									...
									<div class="list-group-item radio form-control">
										...
										<?php
													...
													if($this->FormationModel->recherche_resultat_question_depart_2($id_formation,'Question 9')==1)
													{
								...
								<?php
									...
									<div class="list-group-item radio form-control">
										...
										<?php
													...
													if($this->FormationModel->recherche_resultat_question_depart_3($id_formation,'Question 9')==1)
													{
...
<?php
									...
									<div class="list-group-item radio form-control">
										...
										<?php
													...
													if($this->FormationModel->recherche_resultat_question_depart_4($id_formation,'Question 9')==1)
													{
							...
							<?php
									...
									<div class="list-group-item radio form-control">
										...
										<?php
													...
													if($this->FormationModel->recherche_resultat_question_depart_1($id_formation,'Question 10')==1)
													{
...
<?php
									...
									<div class="list-group-item radio form-control">
										...
										<?php
													...
													if($this->FormationModel->recherche_resultat_question_depart_2($id_formation,'Question 10')==1)
													{
								...
								<?php
									...
									<div class="list-group-item radio form-control">
										...
										<?php
													...
													if($this->FormationModel->recherche_resultat_question_depart_3($id_formation,'Question 10')==1)
													{
								...
								<?php
									...
									<div class="list-group-item radio form-control">
										...
										<?php
													...
													if($this->FormationModel->recherche_resultat_question_depart_4($id_formation,'Question 10')==1)
													{
...
$(document).ready(function(){
    ...
    {
      $.ajax({
        url: "<?php echo site_url('welcome/afficher_note_depart'); ?>",
        type: 'POST',
	...
	*/	
		...
		$.ajax({
				url: "<?php echo site_url('welcome/afficher_resultat_depart'); ?>",
				type: 'POST',
				data : form_data,
				 success: function(data) {
