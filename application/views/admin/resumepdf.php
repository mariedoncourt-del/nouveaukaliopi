...
<div class="card shadow mb-4">
  ...
  <div class="card-body">
    ...
    <div class="table-responsive">
      ...
      <table border="1"  width="100%" cellspacing="0" class="table-striped"> 
  ...
  <h2>Evaluations:</h2>
    ...
    <h3 style="text-decoration: underline;">Auto-evaluation:</h3>
    ...
    <h3 style="text-decoration: underline;">Evaluation par projet:</h3>
  ...
  <?php endif; ?>
    ...
    <h3 style="text-decoration: underline;">Evaluation à chaud:</h3>
